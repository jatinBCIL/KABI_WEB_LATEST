<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/MasterPage.master" AutoEventWireup="true"
    CodeFile="frmPurchaseOrderView.aspx.cs" Inherits="frmPurchaseOrderView" %>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td height="30" style="height: 30px; background-image: url('../App_Themes/Styles/Images/Menu_Out.png');
                                            ...
                                            <asp:Label ID="Label35" runat="server" CssClass="HeadingLabel" Text="&amp;nbsp;Purchase Order Check by"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table cellpadding="5">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnGet" runat="server" CssClass="Button" Text=" GET DATA " Width="150px"
                                                ...
                                                <table cellpadding="5">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="lblEwayBillNo" runat="server" Width="90px" CssClass="TextBox"></asp:TextBox>
                                                            <asp:TextBox ID="txtEwayBillDate" runat="server" Width="105px" CssClass="TextBox"
                                                                Style="margin-left: 5px"></asp:TextBox>
                                                            <asp:Image ID="Image29" runat="server" Height="10px" ImageUrl="../App_Themes/Styles/Images/img_mand.png"
                                                                ToolTip="Mandatory Field!!!" Width="10px" />
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" ControlToValidate="txtEwayBillDate"
                                                                ErrorMessage="RequiredFieldValidator" ToolTip="EwayBillDate is required" ValidationGroup="DataSave"><img 
                                                                src="../App_Themes/Styles/Images/err1.png" alt=""
                                                                title="txtEwayBillDate is required!!!" />
                                                            </asp:RequiredFieldValidator>
                                                            <asp:CalendarExtender ID="CalendarExtender5" runat="server" Enabled="True" TargetControlID="txtEwayBillDate"
                                                                Format="dd-MM-yyyy">
                                                            </asp:CalendarExtender>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtEwayBillDate"
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="lblModeOfTransport" runat="server" CssClass="Combobox" Width="200px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblOrderDate" runat="server" CssClass="Label" Text=""></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label9" runat="server" CssClass="Label" Text="Transporter. :"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="lblTransporter" runat="server" CssClass="Label" Text=""></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label11" runat="server" CssClass="Label" Text="Truck No:"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="lblTruckNo" runat="server" CssClass="Label" Text=""></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label42" runat="server" CssClass="Label" Text="Material code:"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblitemcode_gen" runat="server" CssClass="Label" Text=""></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </asp:Panel>
                                            ...
                                            <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid" BorderColor="Black" BorderWidth="1px">
                                                <table cellpadding="5">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <%-- <asp:TextBox ID="txtEntryGate" runat="server" Width="200px" CssClass="TextBox"></asp:TextBox>
                                                            ...
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtEntryGateDate"
                                                             ValidationExpression="^(0[1-9]|[12][0-9]|3[01])[-](0[1-9]|1[012])[-](19|20)\d\d$" 
                                                              Display="Dynamic" SetFocusOnError="true" ErrorMessage="Date Format Invalid" ></asp:RegularExpressionValidator>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtChallanNo"
                                                             ValidationExpression="^(0[1-9]|[12][0-9]|3[01])[-](0[1-9]|1[012])[-](19|20)\d\d$" 
                                                              Display="Dynamic" SetFocusOnError="true" ErrorMessage="Date Format Invalid" ></asp:RegularExpressionValidator>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:CalendarExtender ID="CalendarExtender3" runat="server" Enabled="True" TargetControlID="txtInvoiceDate"
                                                              ...
                                                              <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtInvoiceDate"
                                                             ValidationExpression="^(0[1-9]|[12][0-9]|3[01])[-](0[1-9]|1[012])[-](19|20)\d\d$" 
                                                              Display="Dynamic" SetFocusOnError="true" ErrorMessage="Date Format Invalid" ></asp:RegularExpressionValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtGRNO" runat="server" Width="220px" CssClass="TextBox"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label61" runat="server" CssClass="Label" Text="GR_GI_SLIP_NO"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtGRGISLIPNO" runat="server" Width="220px" CssClass="TextBox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtHeaderText" runat="server" Width="220px" CssClass="TextBox"></asp:TextBox>
                                                        </td>
                                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <table cellpadding="5">
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnSaveGeneralDetails" runat="server" CssClass="Button" Text="SAVE  (IF ANY DETAILS EDITED THEN ONLY SAVE)" OnClientClick="return confirm('Please check all the details , Are you sure you want to Save');" 
                                                            Width="340px" OnClick="btnSaveGeneralDetails_Click" />
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnNext" runat="server" CssClass="Button" Text="NEXT" Width="90px"
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <asp:Panel ID="Panel7" runat="server" BorderStyle="Solid" BorderColor="Black" BorderWidth="1px">
                                                <table cellpadding="5">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtVendorBatchNo" runat="server" Width="200px" CssClass="TextBox"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:CalendarExtender ID="CalendarExtender2" runat="server" Enabled="True" TargetControlID="txtMfgDate"
                                                              ...
                                                              <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="txtMfgDate"
                                                             ValidationExpression="^(0[1-9]|[12][0-9]|3[01])[-](0[1-9]|1[012])[-](19|20)\d\d$" 
                                                              Display="Dynamic" SetFocusOnError="true" ErrorMessage="Date Format Invalid" ></asp:RegularExpressionValidator>--%>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                           ...
                                                           <%--  <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="txtExpDate"
                                                             ValidationExpression="^(0[1-9]|[12][0-9]|3[01])[-](0[1-9]|1[012])[-](19|20)\d\d$" 
                                                              Display="Dynamic" SetFocusOnError="true" ErrorMessage="Date Format Invalid" ></asp:RegularExpressionValidator>--%>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtGmCode"
                                                                ErrorMessage="RequiredFieldValidator" ToolTip="GM CODE is required" ValidationGroup="Get">
                                                                <img src="../App_Themes/Styles/Images/err1.png" title="GmCode is required!!!" />
                                                            </asp:RequiredFieldValidator>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label36" runat="server" CssClass="Label" Text="Pack_Qty:" style="visibility:hidden"></asp:Label>
                                                        </td>
                                                        <td style=" visibility:hidden">
                                                    ...
                                                    <tr id="trWeight" runat="server" style=" visibility:hidden">
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtNetWt" runat="server" Width="200px" CssClass="TextBox" onkeypress="return numericOnly(this);"></asp:TextBox>
                                                        </td>
                                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <asp:Panel ID="Panel9" runat="server" BorderStyle="Solid" BorderColor="Black" BorderWidth="1px" Visible="true">
                                               <table cellpadding="5">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtgross" runat="server" CssClass="TextBox" Height="25px" 
                                                                onkeypress="return numericOnly(this);" SkinID="NAME" Width="50px"> </asp:TextBox>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtnet" runat="server" CssClass="TextBox" Height="25px" 
                                                                onkeypress="return numericOnly(this);" SkinID="NAME" Width="50px"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txttare" runat="server" CssClass="TextBox" Height="25px" 
                                                                SkinID="NAME" Width="50px"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblpacksize" runat="server" CssClass="Label" Text="Pack Size :"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtpacksize" runat="server" CssClass="TextBox" Height="25px" 
                                                                onkeypress="return numericOnly(this);" SkinID="NAME" Width="50px"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblnoofcontainer" runat="server" CssClass="Label" 
                                                                Text="No of Containers :"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtNoOfContainers" runat="server" CssClass="TextBox" 
                                                                onkeypress="return numericOnly(this);" Width="50px"></asp:TextBox>
                                                        </td>
                                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle" AllowPaging="true"
                                                AutoGenerateColumns="false" PageSize="10" Style="width: 75%; text-align: center"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Pack_Qty" HeaderText="Pack Quantity" SortExpression="Pack_Qty" />
                                                    <asp:BoundField DataField="NoOfContainersRec" HeaderText="No Containers" SortExpression="NoOfContainersRec" />
                                                    <asp:BoundField DataField="GrossWt" HeaderText="Gross Weight" SortExpression="GrossWt" />
                                                    <asp:BoundField DataField="TareWt" HeaderText="Tare Weight" SortExpression="TareWt" />
                                                    <asp:BoundField DataField="NetWt" HeaderText="Net Weight" SortExpression="NetWt" />
                                                    <asp:BoundField DataField="RefNo" HeaderText="RefNo" SortExpression="RefNo" />
                                                </Columns>
                                                <PagerSettings Position="TopAndBottom" />
                                                <RowStyle CssClass="GridViewRowStyle" />
                                    ...
                                    <tr>
                                        <td>
                                            <table cellpadding="5">
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnSaveReceiving" runat="server" CssClass="Button" Text="SAVE (IF ANY DETAILS EDITED THEN ONLY SAVE)" Width="340px"
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnCloseReceiving" runat="server" CssClass="Button" Text="SUBMIT / CLOSE"
                                                            Width="160px" OnClick="btnCloseReceiving_Click" />
                                                    </td>
                                                    <td>
                                                    </td>
                                                    <td>
